...
@Composable
fun ObrasADM(navController: NavController){
    ...
    Column(
        ...
        Row(Modifier.wrapContentSize(Alignment.TopCenter)){
            TextButton(onClick = {navController.navigate(Screen.AutoresADM.route)},
                Modifier.weight(1f)
            ){
                Text(
                    "Autores",
        ...
        ListaDeObras(navController, "edit")
